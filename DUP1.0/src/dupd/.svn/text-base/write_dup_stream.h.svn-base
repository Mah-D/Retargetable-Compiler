...
/**
 * @file dupd/write_dup_stream.h
 * @brief representation of a stream of session type
 * @author Christian Grothoff
 * @author Krista Grothoff
 */
#ifndef DUPD_WRITE_DUP_STREAM_H
#define DUPD_WRITE_DUP_STREAM_H

#include "base_stream.h"
#include "dup_network.h"

class DUPDWriteDupStream:public DUPDStream
{
public:
  DUPDWriteDupStream (DUPDFileDescriptor * fd);

  virtual ~ DUPDWriteDupStream ();
