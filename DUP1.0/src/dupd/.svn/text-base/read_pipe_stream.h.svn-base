...
/**
 * @file dupd/read_pipe_stream.h
 * @brief representation of a stream of session type
 * @author Christian Grothoff
 * @author Krista Grothoff
 */
#ifndef DUPD_READ_PIPE_STREAM_H
#define DUPD_READ_PIPE_STREAM_H

#include "base_stream.h"
#include "dup_network.h"

class DUPDReadPipeStream:public DUPDStream
{
public:
  DUPDReadPipeStream (DUPDFileDescriptor * fd,
                      int64_t sid, int32_t remote_pidx, int32_t remote_fd);

  virtual ~ DUPDReadPipeStream ()
  {
