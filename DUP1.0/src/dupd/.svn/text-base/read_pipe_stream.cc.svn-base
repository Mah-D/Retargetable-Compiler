...
DUPDReadPipeStream::DUPDReadPipeStream (DUPDFileDescriptor * fd, int64_t s_id, int32_t remote_pidx, int32_t remote_fd):DUPDStream (fd,
            0)
{
  r_pidx = remote_pidx;
  r_fd = remote_fd;
...
void
DUPDReadPipeStream::do_attach (DUPDSession * s)
{
  DUPDProcess *p;
