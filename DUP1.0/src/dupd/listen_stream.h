...
/**
 * @file dupd/listen_stream.h
 * @brief representation of the listen socket
 * @author Christian Grothoff
 * @author Krista Grothoff
 */
#ifndef DUPD_LISTEN_STREAM_H
#define DUPD_LISTEN_STREAM_H

#include "base_stream.h"

class DUPDListenStream:public DUPDStream
{
public:
  DUPDListenStream (DUPDFileDescriptor * fd);
