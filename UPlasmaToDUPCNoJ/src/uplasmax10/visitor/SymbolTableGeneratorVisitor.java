...
public class SymbolTableGeneratorVisitor implements GJVisitor<X10Type,X10Type> {
	...
	public X10Type visit(AsyncStatement n, X10Type argu) {
	 ...
	 /**
	    ...
	    * nodeToken9 -> "}"
	    */
	/*   public X10Type visit(ThisAsyncStatement n, X10Type argu) {
		   X10Type _ret=null;
		  n.nodeToken.accept(this, argu);
	      n.nodeToken1.accept(this, argu);
	      n.identifier.accept(this, argu);
	...
	public X10Type visit(LoopStatement n, X10Type argu) {
		...
		n.nodeToken2.accept(this, argu);
		String identifier = n.identifier.accept(this, argu).typeName;
		//removed +1 from symID???? since now has block syntax
	...
	public X10Type visit(DistType n, X10Type argu) {
		X10Type _ret=new X10Distribution(1);    
		n.nodeToken.accept(this, argu);
		      n.nodeToken1.accept(this, argu);
		      n.nodeToken2.accept(this, argu);
		      n.rankEquation.accept(this, argu);
	...
	public X10Type visit(RegionType n, X10Type argu) {
		X10Type _ret=new X10Region(1); 
		n.nodeToken.accept(this, argu);
	      n.nodeToken1.accept(this, argu);
	      n.nodeToken2.accept(this, argu);
	      n.rankEquation.accept(this, argu);
	      n.nodeToken3.accept(this, argu); return _ret;
	}
	...
	public X10Type visit(PointType n, X10Type argu) {
	 ...
	 /**
	    ...
	    * nodeToken9 -> "}"
	    */
	public X10Type visit(AsyncStatementInConstructor n, X10Type argu) {
		X10Type _ret=null;  
		n.nodeToken.accept(this, argu);
	      n.nodeToken1.accept(this, argu);
	      n.identifier.accept(this, argu);
	      ...
	      n.identifier2.accept(this, argu);
	       n.nodeToken7.accept(this, argu);
	      n.nodeToken8.accept(this, argu);
	      n.nodeToken9.accept(this, argu); return _ret;
	}

	public X10Type visit(ExplodedSpecification n, X10Type argu) {
		X10Type _ret=null; 
		n.nodeChoice.accept(this, argu); return _ret;
		
	}

	public X10Type visit(PointName n, X10Type argu) {
		X10Type _ret=null;    
		n.identifier.accept(this, argu); return _ret;
	}

	public X10Type visit(Coordinates n, X10Type argu) {
		X10Type _ret=null; n.nodeToken.accept(this, argu);
	      n.identifier.accept(this, argu);
	      n.nodeToken1.accept(this, argu); return _ret;
	}

	public X10Type visit(SimpleDistributionExpression n, X10Type argu) {
		X10Type _ret=null; n.nodeToken.accept(this, argu);
		      n.nodeToken1.accept(this, argu);
		      n.identifier.accept(this, argu);
		      n.nodeToken2.accept(this, argu);
		      n.nodeToken3.accept(this, argu);
		      n.nodeToken4.accept(this, argu); return _ret;
	}

	public X10Type visit(PlusOffset n, X10Type argu) {
		X10Type _ret=null; n.identifier.accept(this, argu);
	      n.nodeToken.accept(this, argu);
	      n.nodeToken1.accept(this, argu);
	      n.identifierList.accept(this, argu);
	      n.nodeToken2.accept(this, argu); return _ret;
		
	}

	public X10Type visit(TimesOffset n, X10Type argu) {
		X10Type _ret=null;   n.identifier.accept(this, argu);
	      n.nodeToken.accept(this, argu);
	      n.nodeToken1.accept(this, argu);
	      n.identifierList.accept(this, argu);
	...
	public X10Type visit(DivideOffset n, X10Type argu) {
		X10Type _ret=null;  	 n.identifier.accept(this, argu);
	      n.nodeToken.accept(this, argu);
	      n.nodeToken1.accept(this, argu);
	      n.identifierList.accept(this, argu);
	...
	public X10Type visit(PointAccess n, X10Type argu) {
		X10Type _ret=null; 
		n.identifier.accept(this, argu);
	      n.nodeToken.accept(this, argu); return _ret;
		
	}

	public X10Type visit(DotRegionDotSize n, X10Type argu) {
		X10Type _ret=null;
		n.identifier.accept(this, argu);
	      n.nodeToken.accept(this, argu);
	      n.nodeToken1.accept(this, argu);
	      ...
	      n.nodeToken3.accept(this, argu);
	      n.nodeToken4.accept(this, argu);
	      n.nodeToken5.accept(this, argu); return _ret;
	...
	public X10Type visit(NewValueArray n, X10Type argu) {
		...
		n.nodeToken.accept(this, argu);
	      ...
	      n.identifier.accept(this, argu);
	      n.nodeToken3.accept(this, argu);
	      n.arrayInitializer.accept(this, argu); return _ret;
