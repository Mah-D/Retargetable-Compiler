...
public class JPlasmaToCPreBuilding implements GJVoidVisitor<String> {
	...
	public ArrayList<String> myListAsyncConstructorVars = new ArrayList<String>();
	//public ArrayList<String> myListAsyncConstructorParentClass = new ArrayList<String>();
	public HashMap<String,String> myListAsyncConstructorClass = new HashMap<String,String>();
	public ArrayList<StringBuffer> ListOfPointerRepairFuncs = new ArrayList<StringBuffer>();
	...
	public void visit(MainClass n, String argu) {
		...
		myClasses.put(n.identifier.nodeToken.tokenImage, new ClassObject(
				n.identifier.nodeToken.tokenImage,
				new HashMap<String, MethodObject>(),
				new HashMap<String, PairsTypeName>()));
	...
	public void visit(ProgramClass n, String argu) {
		...
		// myClasses.get(currentClassName).myMethods.put(currentMethodName, new
		// MethodObject(currentMethodName, new HashMap<String,
		// PairsTypeName>()));
		n.nodeListOptional.accept(this, argu);
	...
	public void visit(ConstructorDeclaration n, String argu) {
		...
		Integer temp = 0;
		globalTemp++;
		currentMethodName = n.identifier.nodeToken.tokenImage + "_"
				+ globalTemp;
		myClasses.get(currentClassName).myMethods.put(currentMethodName,
				new MethodObject(currentMethodName,
						new HashMap<String, PairsTypeName>()));
		totalParameters = 0;
		n.nodeOptional.accept(this, argu);
		temp = totalParameters;
		MethodObject mo = myClasses.get(currentClassName).myMethods
				.get(currentMethodName);
		myClasses.get(currentClassName).myMethods.put(
				n.identifier.nodeToken.tokenImage + "_" + totalParameters, mo);
	...
	public void visit(ConstantDeclaration n, String argu) {
		...
		if (n.type.nodeChoice.choice instanceof NonArrayType) {
			...
			myClasses.get(currentClassName).myFields.put(
					n.identifier.nodeToken.tokenImage, new PairsTypeName(
							n.identifier.nodeToken.tokenImage,
							convertToRightSymbol(nat), false,
							convertToNameType(nat)));
	...
	public void visit(InitializableConstantDeclaration n, String argu) {
		...
		if (n.type.nodeChoice.choice instanceof NonArrayType) {
			...
			if (((NonArrayType) n.type.nodeChoice.choice).nodeChoice.choice instanceof ClassNameType) {
				myListOfDep
						.add(((ClassNameType) ((NonArrayType) n.type.nodeChoice.choice).nodeChoice.choice).identifier.nodeToken.tokenImage);
			}
		}
		n.nodeToken2.accept(this, argu);
	}
	...
	public void visit(FinalFormalParameter n, String argu) {
		...
		if (n.type.nodeChoice.choice instanceof NonArrayType) {
			...
			myClasses.get(currentClassName).myMethods.get(currentMethodName).myLocalsParams
					.put(n.identifier.nodeToken.tokenImage + blockid,
							new PairsTypeName(
									n.identifier.nodeToken.tokenImage,
									convertToRightSymbol(nat), false,
									convertToNameType(nat)));
	 ...
	 * nodeToken2 -> ")" nodeToken3 -> "{" identifier1 -> Identifier()
	 * nodeToken4 -> "." identifier2 -> Identifier() nodeToken5 -> "("
	 * identifier3 -> Identifier() nodeToken6 -> ")" nodeToken7 -> ";"
	 * nodeToken8 -> "}"
	 */
	...
	/**
	 * nodeToken -> "async" nodeToken1 -> "(" identifier -> Identifier()
	 * nodeToken2 -> ")" nodeToken3 -> "{" nodeToken4 -> "this" nodeToken5 ->
	 * "." identifier1 -> Identifier() nodeToken6 -> "(" identifier2 ->
	 * Identifier() nodeToken7 -> ")" nodeToken8 -> ";" nodeToken9 -> "}"
	 */
	/*public void visit(ThisAsyncStatement n, String argu) {
		n.nodeToken.accept(this, argu);
		n.nodeToken1.accept(this, argu);
		n.identifier.accept(this, argu);
		n.nodeToken2.accept(this, argu);
		...
		n.nodeToken6.accept(this, argu);
		n.identifier2.accept(this, argu);
		String asyncVariableName = n.identifier2.nodeToken.tokenImage;
		myListAsyncConstructorVars.add(asyncVariableName);
		if (symbolTable.lookupVariableInScope(asyncVariableName, blockid, currentClassName, currentMethodName)!=null) {
			String className = symbolTable.lookupVariableInScope(asyncVariableName, blockid, currentClassName, currentMethodName).symbolType.getFlatTypeName();
			myListAsyncConstructorClass.put(className, currentClassName);
		}
		n.nodeToken7.accept(this, argu);
		n.nodeToken8.accept(this, argu);
		n.nodeToken9.accept(this, argu);
...
/**
	...
	public String convertToRightSymbol(NonArrayType nat) {
		...
		if (node instanceof ClassNameType) {
			return "%class";
		} else if (node instanceof PlaceType || node instanceof IntegerType
				|| node instanceof ShortType || node instanceof ByteType) {
			return "%d";
	...
	public String convertToNameType(NonArrayType nat) {
		String myLocalType = "";
		Node node = nat.nodeChoice.choice;
		if (node instanceof ClassNameType) {
			myLocalType = ((ClassNameType) node).identifier.nodeToken.tokenImage;
		} else if (node instanceof IntegerType || node instanceof DoubleType
				|| node instanceof LongType || node instanceof ShortType
				|| node instanceof ByteType) {
			myLocalType = "Number value";
		} else if (node instanceof BooleanType) {
			myLocalType = "boolean";
		} else if (node instanceof StringType) {
			myLocalType = "char *";
	...
	public String convertToUpdateNameType(UpdatableArrayType nat) {
		String myLocalType = "";
		...
		if (n.type.nodeChoice.choice instanceof NonArrayType) {
			...
			myClasses.get(currentClassName).myMethods.get(currentMethodName).myLocalsParams
					.put(n.identifier.nodeToken.tokenImage + blockid,
							new PairsTypeName(
									n.identifier.nodeToken.tokenImage,
									convertToRightSymbol(nat), false,
									convertToNameType(nat), false, false));
			...
			myClasses.get(currentClassName).myMethods.get(currentMethodName).myLocalsParams
					.put(n.identifier.nodeToken.tokenImage + blockid,
							new PairsTypeName(
									n.identifier.nodeToken.tokenImage,
									convertToRightSymbolArrays(nat), false,
									convertToUpdateNameType(nat),false,true));
		}
		n.nodeToken1.accept(this, argu);
		n.expression.accept(this, argu);
		n.nodeToken2.accept(this, argu);
