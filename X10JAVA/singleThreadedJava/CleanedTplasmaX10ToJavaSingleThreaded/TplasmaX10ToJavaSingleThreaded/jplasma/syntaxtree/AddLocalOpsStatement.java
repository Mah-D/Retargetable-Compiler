 ...
 * nodeToken3 -> ";"
 */
public class AddLocalOpsStatement implements Node {
   ...
   public AddLocalOpsStatement(NodeToken n0, NodeToken n1, Identifier n2, NodeToken n3, NodeToken n4) {
      nodeToken = n0;
      nodeToken1 = n1;
      identifier = n2;
      nodeToken2 = n3;
   ...
   public AddLocalOpsStatement(Identifier n0) {
      nodeToken = new NodeToken("x10.lang.perf.addLocalOps");
