...
public class TPlasmaToJPlasma extends GJDepthFirst<Snippet,Snippet>{
	...
	private String initCodePlaceChecks = "\nint maxPlaces =4;\nfor(int i =0; i <maxPlaces; ++i){Program.globalPointerHashMap.put(i, new HashSet<Integer>());}\n";
	private boolean inConstructor = false;
	
	
	public TPlasmaToJPlasma(HashMap<String, SymbolTableClassEntry> classSymbolTable, boolean options[])
	{
	...
	private String generateTabs(int numTabs)
	{
	 ...
	 public Snippet visit(NodeListOptional n, Snippet argu) {
	   ...
	   public Snippet visit(Block n, Snippet argu) {
	      ...
	      n.nodeToken.accept(this, argu);
			...
			if(inConstructorInit){
				...
				tPlasmaCode+=initCodePlaceChecks;
				...
				if(!inAsync){
					...
					toAdd+="\nProgram.globalPointerHashMap.get("+asyncPoint+").add("+"this"+".hashCode());";
				}
	   ...
	   /**TODO THIS NEEDS FIXING PROBABLY A CLASS
...
//	     }else{
	   ...
	   public Snippet visit(SwitchStatement n, Snippet argu) {
	     ...
	     Snippet f2 =  n.identifier.accept(this, argu);
	      ...
	      n.nodeToken4.accept(this, argu);
	      _ret.returnTemp = generateTabs(blockDepth)+"switch("+f2.returnTemp+"){\n"+f5.returnTemp+"\n}";
			tPlasmaCode+=_ret.returnTemp+"\n";
	      return _ret;
	   }
...
//	      }else{
	   ...
	   /**TODO needs to be translated somehow
	    * nodeToken -> "["
	    * nodeToken1 -> "0 :"
	    * identifier -> Identifier()
	    * nodeToken2 -> "]"
	...
	private Object classToAddToGlobalHash;
	   ...
	   public Snippet visit(NewUpdatableArray n, Snippet argu) {
	      Snippet _ret= new Snippet("","",null,false);
	      n.nodeToken.accept(this, argu);
	     Snippet f1 = n.nonArrayType.accept(this, argu);
	      n.nodeToken1.accept(this, argu);
	     Snippet f3 = n.identifier.accept(this, argu);
	      n.nodeToken2.accept(this, argu);
	      //_ret.returnTemp = "new "+f1.expType.typeName.toUpperCase()+"Array("+f3.returnTemp+")";
	      _ret.returnTemp = "new "+f1.expType.typeName+"["+f3.returnTemp+"]";
	      return _ret;
	   }
	   ...
	   public Snippet visit(PlaceMaxPlaces n, Snippet argu) {
	      Snippet _ret= new Snippet("","4",null,false);
	      //_ret = n.nodeToken.accept(this, argu);
	      _ret.expType = new X10Integer();
	      return _ret;
	   }
