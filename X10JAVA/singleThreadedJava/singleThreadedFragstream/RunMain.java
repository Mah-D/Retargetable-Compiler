...
public static final int _FragmentedStream_MEG = Program._FragmentedStream_MEG_init(myUniquePlacePoint);
public static final double _FragmentedStream_alpha = Program._FragmentedStream_alpha_init(myUniquePlacePoint);
public static final int _FragmentedStream_NUM_TIMES = Program._FragmentedStream_NUM_TIMES_init(myUniquePlacePoint);
public static final int _Timer_max_counters = Program._Timer_max_counters_init(myUniquePlacePoint);
public static final long _FragmentedStream_N0 = Program._FragmentedStream_N0_init(myUniquePlacePoint);
public static final long _FragmentedStream_N = Program._FragmentedStream_N_init(myUniquePlacePoint);
public static final int _FragmentedStream_LocalSize = Program._FragmentedStream_LocalSize_init(myUniquePlacePoint);
...
Program.globalPointerHashMap.get(myUniquePlacePoint).add(tmr.hashCode());
		...
		final FragmentedStream X10_TEMP4 = new FragmentedStream(myUniquePlacePoint);
		
Program.globalPointerHashMap.get(myUniquePlacePoint).add(X10_TEMP4.hashCode());

		Program.FragmentedStream_run(X10_TEMP4,myUniquePlacePoint);
...
public static int _FragmentedStream_MEG_init (  int myUniquePlacePoint)
		{
...
public static double _FragmentedStream_alpha_init (  int myUniquePlacePoint)
		{
...
public static int _FragmentedStream_NUM_TIMES_init (  int myUniquePlacePoint)
		{
...
public static long _FragmentedStream_N0_init (  int myUniquePlacePoint)
		{
...
public static long _FragmentedStream_N_init (  int myUniquePlacePoint)
		{
...
public static int _FragmentedStream_LocalSize_init (  int myUniquePlacePoint)
		{
...
public static void FragmentedStream_run ( final FragmentedStream X10_TEMP0, int myUniquePlacePoint)
		{
					...
					for(int RX10_TEMP5=0; RX10_TEMP5 < RX10_TEMP8; RX10_TEMP5++)
						...
						//async(X10_TEMP16)
							...
							if(X10_TEMP55)
								...
								final double X10_TEMP58 = Program.FragmentedStream_mySecond(X10_TEMP16);
					...
					for(int RX10_TEMP97=0; RX10_TEMP97 < RX10_TEMP100; RX10_TEMP97++)
						...
						//async(X10_TEMP84)
							...
							if(X10_TEMP90)
								...
								final double X10_TEMP96 = Program.FragmentedStream_mySecond(X10_TEMP84);
...
Program.globalPointerHashMap.get(myUniquePlacePoint).add(RX10_TEMP225.hashCode());
		...
		Program.FragmentedStream_printStats(_FragmentedStream_N, mini, X10_TEMP156,myUniquePlacePoint);
		}
public static double FragmentedStream_mySecond (  int myUniquePlacePoint)
		{
...
public static void FragmentedStream_printStats ( final long N, final double time, final boolean verified, int myUniquePlacePoint)
		{
...
Program.globalPointerHashMap.get(myUniquePlacePoint).add(retReg.hashCode());
	...
	/*value*/ class FragmentedStreamData 
	 {
	...
	public FragmentedStreamData ( final long N, final int NUM_TIMES, int myUniquePlacePoint)
		{
		...
		final booleanRefArray1 X10_TEMP11 = this.FragmentedStreamData_initVerified(dverified,myUniquePlacePoint);
		...
		final doubleRefArray1 X10_TEMP37 = this.FragmentedStreamData_initArray(X10_TEMP35,myUniquePlacePoint);


		times = X10_TEMP37;


		final doubleRefArray1 X10_TEMP41 = this.FragmentedStreamData_initArray(tempD,myUniquePlacePoint);


		a = X10_TEMP41;


		final doubleRefArray1 X10_TEMP45 = this.FragmentedStreamData_initArray(tempD,myUniquePlacePoint);


		b = X10_TEMP45;


		final doubleRefArray1 X10_TEMP49 = this.FragmentedStreamData_initArray(tempD,myUniquePlacePoint);
...
public booleanRefArray1 FragmentedStreamData_initVerified ( final Dist1 d, int myUniquePlacePoint)
		{
...
public doubleRefArray1 FragmentedStreamData_initArray ( final Dist1 d, int myUniquePlacePoint)
		{
...
Program.globalPointerHashMap.get(myUniquePlacePoint).add(RX10_TEMP20.hashCode());
	...
	public FragmentedStream (  int myUniquePlacePoint)
		{
		...
		final FragmentedStreamData X10_TEMP6 = new FragmentedStreamData(X10_TEMP3, X10_TEMP4,myUniquePlacePoint);
