...
import jplasma.parser.TPlasmaX10Parser;
import jplasma.visitor.TPlasmaToJPlasma;
import jplasma.visitor.TplasmaX10JavaSingleThreaded;
...
public class ReMain {
	public static void main(String [] args) {
		try {
			...
			//String home = "C:\\Users\\atexannamedbob\\Desktop\\";
			//String home = "/Users/orenfreiberg/Desktop/benchmarks/benchmarks/stream/splasma/";
			//String home = "/Users/orenfreiberg/Desktop/benchmarks/benchmarks/stream/splasma/";
			String home = "/Users/orenfreiberg/Desktop/benchmarks/uplasmaBenchmarks/benchmarks/crypt/uplasma/";
			//String dest[] = {"RunMain.x10"};
			 ...
			 */
			int i = 0;
			File input = new File(home+fileName);
			...
			try {
				...
				jplasma.syntaxtree.Node root2 = new TPlasmaX10Parser(buffy).File();

				TplasmaX10JavaSingleThreaded tpjsv = new jplasma.visitor.TplasmaX10JavaSingleThreaded(stgv.classSymbolTable, null);
