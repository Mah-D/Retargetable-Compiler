...
/*END*/
/*intGetValue*/
	public static int IntegerGetValue(final IntegerArray arr, final int index){
		final place pl = here;
...
/*END*/
/*intSetValue*/	
	public static void IntegerSetValue(final IntegerArray arr, final int index, final int val){
		final place pl = here;
		final int placeIndex = pl.id;
		final IntegerStub value[:rank==1] contents = arr.contents;	
		final IntegerStub indexStub = contents[placeIndex];
