...
/* Generated By:JavaCC: Do not edit this line. SPlasmaX10Parser.java */
import splasmax10.syntaxtree.*;

import java.util.Vector;


public class SPlasmaX10Parser implements SPlasmaX10ParserConstants {
  ...
  static final public Expression Expression() throws ParseException {
   ...
   DistributionExpression n4;
   DistributionUnionExpression n5;
   ConditionalAndExpression n6;
   InclusiveOrExpression n7;
   ExclusiveOrExpression n8;
   AndExpression n9;
   EqualsExpression n10;
   NonEqualsExpression n11;
   LessThanExpression n12;
   GreaterThanExpression n13;
   LessThanEqualExpression n14;
   GreaterThanEqualExpression n15;
   ShiftLeftExpression n16;
   ShiftRightExpression n17;
   ShiftRightUnsignedExpression n18;
   PlusExpression n19;
   MinusExpression n20;
   TimesExpression n21;
   DivideExpression n22;
   ModulusExpression n23;
   RegionConstant n24;
   SinExpression n25;
   CosExpression n26;
   PowExpression n27;
   ...
   MaxExpression n32;
   LogExpression n33;
   ComplimentExpression n34;
   NotExpression n35;
   CoercionToIntExpression n36;
   CoercionToDoubleExpression n37;
   CoercionToLongExpression n38;
   CoercionToShortExpression n39;
   CoercionToByteExpression n40;
   TypeAnnotatedExpression n41;
   Place n42;
   CurrentTime n43;
   ArrayAccess n44;
   MethodCall n45;
   MethodCallInConstructor n46;
   DotId n47;
   DotIdentifierDotGet n48;
   DotNext n49;
   DotPrev n50;
   DotIsFirst n51;
   DotIsLast n52;
   DotIdentifierDotRegionDotSize n53;
   DotIdentifier n54;
   NewObject n55;
   NewValueArray n56;
   NewUpdatableArray n57;
   IntegerLiteral n58;
   LongLiteral n59;
   HexLiteral n60;
   FloatingPointLiteral n61;
   StringLiteral n62;
   True n63;
   False n64;
   HereLiteral n65;
   ...
   Identifier n70;
    if (jj_2_18(2147483647)) {
      ...
      n4 = DistributionExpression();
        n0 = new NodeChoice(n4, 3);
    } else if (jj_2_22(4)) {
      n5 = DistributionUnionExpression();
        n0 = new NodeChoice(n5, 4);
    } else if (jj_2_23(4)) {
      n6 = ConditionalAndExpression();
        n0 = new NodeChoice(n6, 5);
    } else if (jj_2_24(4)) {
      n7 = InclusiveOrExpression();
        n0 = new NodeChoice(n7, 6);
    } else if (jj_2_25(4)) {
      n8 = ExclusiveOrExpression();
        n0 = new NodeChoice(n8, 7);
    } else if (jj_2_26(4)) {
      n9 = AndExpression();
        n0 = new NodeChoice(n9, 8);
    } else if (jj_2_27(4)) {
      n10 = EqualsExpression();
        n0 = new NodeChoice(n10, 9);
    } else if (jj_2_28(4)) {
      n11 = NonEqualsExpression();
        n0 = new NodeChoice(n11, 10);
    } else if (jj_2_29(4)) {
      n12 = LessThanExpression();
        n0 = new NodeChoice(n12, 11);
    } else if (jj_2_30(4)) {
      n13 = GreaterThanExpression();
        n0 = new NodeChoice(n13, 12);
    } else if (jj_2_31(4)) {
      n14 = LessThanEqualExpression();
        n0 = new NodeChoice(n14, 13);
    } else if (jj_2_32(4)) {
      n15 = GreaterThanEqualExpression();
        n0 = new NodeChoice(n15, 14);
    } else if (jj_2_33(4)) {
      n16 = ShiftLeftExpression();
        n0 = new NodeChoice(n16, 15);
    } else if (jj_2_34(4)) {
      n17 = ShiftRightExpression();
        n0 = new NodeChoice(n17, 16);
    } else if (jj_2_35(4)) {
      n18 = ShiftRightUnsignedExpression();
        n0 = new NodeChoice(n18, 17);
    } else if (jj_2_36(4)) {
      n19 = PlusExpression();
        n0 = new NodeChoice(n19, 18);
      ...
      n22 = DivideExpression();
        n0 = new NodeChoice(n22, 21);
    } else if (jj_2_40(4)) {
      n23 = ModulusExpression();
        n0 = new NodeChoice(n23, 22);
    } else if (jj_2_41(4)) {
      n24 = RegionConstant();
        n0 = new NodeChoice(n24, 23);
      ...
      n34 = ComplimentExpression();
        n0 = new NodeChoice(n34, 33);
    } else if (jj_2_52(4)) {
      n35 = NotExpression();
        n0 = new NodeChoice(n35, 34);
    } else if (jj_2_53(4)) {
      n36 = CoercionToIntExpression();
        n0 = new NodeChoice(n36, 35);
    } else if (jj_2_54(4)) {
      n37 = CoercionToDoubleExpression();
        n0 = new NodeChoice(n37, 36);
    } else if (jj_2_55(4)) {
      n38 = CoercionToLongExpression();
        n0 = new NodeChoice(n38, 37);
    } else if (jj_2_56(4)) {
      n39 = CoercionToShortExpression();
        n0 = new NodeChoice(n39, 38);
    } else if (jj_2_57(4)) {
      n40 = CoercionToByteExpression();
        n0 = new NodeChoice(n40, 39);
    } else if (jj_2_58(4)) {
      n41 = TypeAnnotatedExpression();
      ...
      n46 = MethodCallInConstructor();
        n0 = new NodeChoice(n46, 45);
    } else if (jj_2_64(4)) {
      n47 = DotId();
        n0 = new NodeChoice(n47, 46);
    } else if (jj_2_65(6)) {
      n48 = DotIdentifierDotGet();
      ...
      n53 = DotIdentifierDotRegionDotSize();
  ...
  static final public SimpleDistributionExpression SimpleDistributionExpression() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n10;
    ...
    n6 = jj_consume_token(RSQPAREN);
            n5 = JTBToolkit.makeNodeToken(n6);
    n8 = jj_consume_token(126);
             n7 = JTBToolkit.makeNodeToken(n8);
    n10 = jj_consume_token(HERE);
                n9 = JTBToolkit.makeNodeToken(n10);
     {if (true) return new SimpleDistributionExpression(n0,n2,n4,n5,n7,n9);}
    throw new Error("Missing return statement in function");
  }
  ...
  static public SPlasmaX10ParserTokenManager token_source;
  ...
  static final private JJCalls[] jj_2_rtns = new JJCalls[92];
  static private boolean jj_rescan = false;
  static private int jj_gc = 0;

  public SPlasmaX10Parser(java.io.InputStream stream) {
     this(stream, null);
  }
  public SPlasmaX10Parser(java.io.InputStream stream, String encoding) {
    ...
    token_source = new SPlasmaX10ParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public SPlasmaX10Parser(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser.  You must");
      System.out.println("       either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public SPlasmaX10Parser(SPlasmaX10ParserTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser.  You must");
      System.out.println("       either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public void ReInit(SPlasmaX10ParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
