 ...
 * f2 -> Identifier()
 */
public class DistributionExpression implements Node {
   public Identifier f0;
   public NodeToken f1;
   public Identifier f2;

   public DistributionExpression(Identifier n0, NodeToken n1, Identifier n2) {
      f0 = n0;
      f1 = n1;
      f2 = n2;
   }

   public DistributionExpression(Identifier n0, Identifier n1) {
      f0 = n0;
      f1 = new NodeToken("->");
      f2 = n1;
   }
