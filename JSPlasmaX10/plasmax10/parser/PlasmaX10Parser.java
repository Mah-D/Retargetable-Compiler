...
public class PlasmaX10Parser implements PlasmaX10ParserConstants {
  ...
  static final public Statement Statement() throws ParseException {
   ...
   Block n4;
   BreakStatement n5;
   ContinueStatement n6;
   DoStatement n7;
   FinishStatement n8;
   IfStatement n9;
   LoopStatement n10;
   PostfixStatement n11;
   PrintlnStatement n12;
   PrintStatement n13;
   PrintErrorStatement n14;
   ReturnStatement n15;
   SwitchStatement n16;
   ThrowStatement n17;
   WhileStatement n18;
    if (jj_2_14(2147483647)) {
      ...
      case 156:
      case 157:
        n11 = PostfixStatement();
        n0 = new NodeChoice(n11, 10);
        break;
      case PRINTLN:
        n12 = PrintlnStatement();
        n0 = new NodeChoice(n12, 11);
        break;
      case PRINT:
        n13 = PrintStatement();
  ...
  static final public Assignment Assignment() throws ParseException {
   ...
   Token n4;
    ...
    n4 = jj_consume_token(SEMICOLON);
            n3 = JTBToolkit.makeNodeToken(n4);
     {if (true) return new Assignment(n0,n1,n2,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public AssignmentOperator AssignmentOperator() throws ParseException {
   NodeChoice n0;
   PlainAssignment n1;
   MultiplyAssignment n2;
   DivideAssignment n3;
   ModuloAssignment n4;
   PlusAssignment n5;
   MinusAssignment n6;
   ShiftLeftAssignment n7;
   ShiftRightAssignment n8;
   ShiftRightUnsignedAssignment n9;
   AndAssignment n10;
   XOrAssignment n11;
   OrAssignment n12;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    case 131:
      ...
      break;
    case 132:
      n7 = ShiftLeftAssignment();
        n0 = new NodeChoice(n7, 6);
      break;
    case 133:
      n8 = ShiftRightAssignment();
        n0 = new NodeChoice(n8, 7);
      break;
    case 134:
      n9 = ShiftRightUnsignedAssignment();
        n0 = new NodeChoice(n9, 8);
      break;
    case 135:
      n10 = AndAssignment();
  ...
  static final public PlainAssignment PlainAssignment() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(ASSIGN);
            n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new PlainAssignment(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public MultiplyAssignment MultiplyAssignment() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(127);
             n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new MultiplyAssignment(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public DivideAssignment DivideAssignment() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(128);
             n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new DivideAssignment(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public ModuloAssignment ModuloAssignment() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(129);
             n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new ModuloAssignment(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public PlusAssignment PlusAssignment() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(130);
             n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new PlusAssignment(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public MinusAssignment MinusAssignment() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(131);
             n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new MinusAssignment(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public ShiftLeftAssignment ShiftLeftAssignment() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(132);
              n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new ShiftLeftAssignment(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public ShiftRightAssignment ShiftRightAssignment() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(133);
              n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new ShiftRightAssignment(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public ShiftRightUnsignedAssignment ShiftRightUnsignedAssignment() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(134);
               n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new ShiftRightUnsignedAssignment(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public AndAssignment AndAssignment() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(135);
             n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new AndAssignment(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public XOrAssignment XOrAssignment() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(136);
             n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new XOrAssignment(n0);}
    throw new Error("Missing return statement in function");
  }

  static final public OrAssignment OrAssignment() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(137);
             n0 = JTBToolkit.makeNodeToken(n1);
     {if (true) return new OrAssignment(n0);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x3000000,0x2000000,0x0,0x0,0x0,0x0,0x0,0x4000000,0x0,0x4000000,0x0,0x0,0x4000000,0x0,0x0,0x200000,0x0,0xe8002200,0x20000,0xec002200,0x4000000,0xe8002200,0x10000000,0x0,0x800,0x0,0x60580a00,0x0,0xec002200,0x0,0x800000,0x0,0x200000,0x0,0x0,0x0,0x0,0x0,0x40000,0x40000,0x0,0x0,0x180000,0x180000,0x0,0x0,0x0,0x60580a00,0x0,0x60580a00,0x580000,0x60000200,0x60000200,0x60000000,0x0,0x0,0x800,0x60580a00,0x60580a00,0x60000000,0x0,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x4000,0x4000,0x4000,0x4000,0x4000,0x4000,0x4000,0x20006,0x4000,0x20006,0x4000,0x0,0x20006,0x20007,0x20006,0x0,0x20006,0x4c7c8008,0x0,0x4cfe800e,0x0,0x4cfc8008,0x0,0x0,0x0,0x0,0xc440008,0x0,0x4cfe800e,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc440008,0x0,0xc440008,0x0,0xc440008,0xc440008,0x40000,0x8,0x0,0x0,0xc440008,0xc440008,0x0,0x0,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x40000000,0x0,0x40000000,0x40000000,0x80087c,0x40000000,0x80087c,0x40000000,0x0,0x80087c,0x80087c,0x80087c,0x0,0x80087c,0x80017101,0x0,0x8081797d,0x0,0x80017101,0x0,0x80002000,0x0,0x0,0x10100,0x0,0x8081797d,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10100,0x0,0x10100,0x0,0x10100,0x10100,0x10000,0x0,0x0,0x0,0x10100,0x10100,0x0,0x0,};
   }
   private static void jj_la1_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x400002,0x0,0x400002,0x0,0x10000000,0x400002,0x400002,0x400002,0x0,0x400002,0x6592f4,0x80000000,0x6592f6,0x0,0x6592f4,0x0,0x20,0x400000,0x10000000,0x6590c0,0x900,0x6592f6,0x900,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x40000000,0x8000000,0x8000000,0x6000000,0x6000000,0x0,0x0,0x0,0x0,0x0,0x6590c0,0x10000000,0x6590c0,0x0,0x6590c0,0x6590c0,0x2590c0,0x0,0x400000,0x0,0x6590c0,0x6590c0,0x2590c0,0x10000000,};
   }
   private static void jj_la1_4() {
      jj_la1_4 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3e000000,0x3ff,0x3e000000,0x0,0x3e000000,0x0,0x0,0x0,0x0,0x3fc00000,0x0,0x3e000000,0x0,0x0,0x400,0x0,0x800,0x1000,0x2000,0x4000,0x4000,0x18000,0x18000,0x20000,0x20000,0x0,0x0,0x1c0000,0x1c0000,0x200000,0x3fc00000,0x0,0x3fc00000,0x1c00000,0x3e000000,0x3e000000,0x3c000000,0x0,0x0,0x0,0x3fc00000,0x3fc00000,0x3c000000,0x0,};
   }
