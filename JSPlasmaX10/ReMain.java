...
import tplasmax10.parser.TPlasmaX10Parser;
import tplasmax10.visitor.TPlasmaX10ToJSPlasmaX10Visitor;
	...
	public static void main(String [] args) {
		try {
			...
			try {
				...
				tplasmax10.syntaxtree.Node root2 = new TPlasmaX10Parser(buffy).File();
				tplasmax10.visitor.TPlasmaX10ToJSPlasmaX10Visitor tpjsv = new TPlasmaX10ToJSPlasmaX10Visitor(stgv.classSymbolTable, null);
