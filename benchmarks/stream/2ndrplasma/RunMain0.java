...
final public static x10.
      lang.
      dist
      _Program__Stream_dverified =
      Program0.
        _Program__Stream_dverified_init();
...
final public static x10.
      lang.
      dist
      _Program__Stream_dtimes =
      Program0.
        _Program__Stream_dtimes_init();
    
//#line 15
final public static x10.
      lang.
      BooleanReferenceArray
      _Program__Stream_verified =
      Program0.
        _Program__Stream_verified_init();
...
final public static x10.
      ...
      _Program__Stream_times =
      Program0.
        _Program__Stream_times_init();
...
final x10.
          ...
          (x10.
            ...
            dist)
            ((Program0.
                Program__Stream_dverified_init()));
...
//#line 105
final Stream X10_TEMP126 =
          (new Stream(
             ));
        
//#line 107
final Stream X10_TEMP1 =
          (X10_TEMP126);
...
final x10.
          ...
          (x10.
            lang.
            BooleanReferenceArray)
            ((/* template:array_specialized_init { */x10.array.sharedmemory.SpecializedArrayFactory.factory.BooleanArray(_Program__Stream_dverified,/* template:array_init_closure { */new x10.array.Operator.Pointwise() {
...
final x10.
          ...
          (x10.
            lang.
            DoubleReferenceArray)
            ((/* template:array_specialized_init { */x10.array.sharedmemory.SpecializedArrayFactory.factory.DoubleArray(_Program__Stream_dtimes,/* template:array_init_closure { */new x10.array.Operator.Pointwise() {
...
final x10.
          ...
          (x10.
            lang.
            DoubleReferenceArray)
            ((/* template:array_specialized_init { */x10.array.sharedmemory.SpecializedArrayFactory.factory.DoubleArray(_Program__Stream_D,/* template:array_init_closure { */new x10.array.Operator.Pointwise() {
              	public double apply(/* Join: { */x10.
                lang.
...
//#line 349
/* template:array_set { */(_Program__Stream_b).set((X10_TEMP187),i)/* } */;
...
//#line 368
/* template:array_set { */(_Program__Stream_c).set((X10_TEMP208),i)/* } */;
                            }/* } */
                            	}
                            } else {
                            	/* template:forloop { */
...
//#line 388
/* template:array_set { */(_Program__Stream_times).set((X10_TEMP229),p1)/* } */;
                            }
...
final double X10_TEMP239 =
                                  (/* template:array_get { */((_Program__Stream_b).get(i))/* } */);
...
final double X10_TEMP243 =
                                  (/* template:array_get { */((_Program__Stream_c).get(i))/* } */);
...
//#line 415
/* template:array_set { */(_Program__Stream_a).set((X10_TEMP259),i)/* } */;
                            }/* } */
                            	}
                            } else {
                            	/* template:forloop { */
...
final double X10_TEMP277 =
                                  (/* template:array_get { */((_Program__Stream_times).get(p1))/* } */);
...
//#line 447
/* template:array_set { */(_Program__Stream_times).set((X10_TEMP290),p1)/* } */;
                            }
                        }
                        		}
                        	});/* } */
...
final double X10_TEMP310 =
                              (/* template:array_get { */((_Program__Stream_a).get(i))/* } */);
...
//#line 501
/* template:array_set { */(_Program__Stream_verified).set((X10_TEMP344),X10_TEMP96)/* } */;
                                }
                                		}
                                	});/* } */
                            }
...
final boolean X10_TEMP384 =
          (/* template:array_get { */((_Program__Stream_verified).get(X10_TEMP121))/* } */);
