...
class MyProgram {
  public static final region(:rank==1) r = Program.initial_value_of_r();
  public static final dist(:rank==1) d = Program.initial_value_of_d();
  public static region(:rank==1) initial_value_of_r() { 
    final int threehundred = 300;
    final region(:rank==1) r1 = [0 : threehundred];
    return r1;
  }
  public static region(:rank==1) initial_value_of_d() { 
    final dist(:rank==1) d1 = (dist(:rank==1))(dist.factory.block(r));
    return d1;
  }
