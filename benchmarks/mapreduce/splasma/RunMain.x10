...
class Program {
		...
		finish {
			for(int RX10_TEMP9=0;RX10_TEMP9<RX10_TEMP6;RX10_TEMP9++) {
				...
				async(RX10_TEMP12) {
					...
					async(RX10_TEMP10) {
						RX10_TEMP8[RX10_TEMP11] = (RX10_TEMP17);
					}
				}
			}
		}
		final intStub[] RX10_TEMP18 = new intStub[RX10_TEMP6];
		for(int RX10_TEMP20=0;RX10_TEMP20<RX10_TEMP6;RX10_TEMP20++) {
	...
	public static Dist1 getBlockDist1(final Region1 r) {
		...
		if(cond) {
			final place[] vPlaceArray = new place [dReg];
	...
	public static Point1[] getDistLocalArray1(final Dist1 dn, final int placeIndex) {
		...
		final Point1[]  vPointArray = new Point1 [localRegion];
		for(int p=0;p<localRegion;p++)
		{
		...
		finish {
			for(int RX10_TEMP7=0;RX10_TEMP7<RX10_TEMP4;RX10_TEMP7++) {
				...
				async(RX10_TEMP10) {
					...
					final int[] RX10_TEMP16 = new int [RX10_TEMP15];
					for(int RX10_TEMP14=0;RX10_TEMP14<RX10_TEMP15;RX10_TEMP14++) {
					...
					final intStub RX10_TEMP17 = new intStub(RX10_TEMP16);
					async(RX10_TEMP8) {
						RX10_TEMP6[RX10_TEMP9] = (RX10_TEMP17);
					}
				}
			}
		}
		final intStub[] RX10_TEMP18 = new intStub [RX10_TEMP4];
		for(int RX10_TEMP20=0;RX10_TEMP20<RX10_TEMP4;RX10_TEMP20++) {
		...
		finish {
			for(int RX10_TEMP7=0;RX10_TEMP7<RX10_TEMP4;RX10_TEMP7++) {
				...
				async(RX10_TEMP10) {
					...
					async(RX10_TEMP8) {
						RX10_TEMP6[RX10_TEMP9] = (RX10_TEMP16);
					}
				}
			}
		}
		...
		finish {
			for(int RX10_TEMP28=0;RX10_TEMP28<RX10_TEMP25;RX10_TEMP28++) {
				...
				async(RX10_TEMP31) {
					...
					async(RX10_TEMP29) {
						RX10_TEMP27[RX10_TEMP30] = (RX10_TEMP37);
					}
				}
			}
		}
		...
		finish {
			for(int RX10_TEMP49=0;RX10_TEMP49<RX10_TEMP46;RX10_TEMP49++) {
				...
				async(RX10_TEMP52) {
					...
					async(RX10_TEMP50) {
						RX10_TEMP48[RX10_TEMP51] = (RX10_TEMP58);
					}
				}
			}
		}
