class Data1 {
	public static void fill(final double[:rank==1] d) {
		d[300] = 104.2500;
		d[301] = 104.5000;
		d[302] = 105.0000;
		d[303] = 106.5000;
...
class CallAppDemo {
	...
	public void validate() {
		...
		double dev = Math.abs(ap.result[0] - ref);
		if(dev > 1.0e-12) {
...
class AppDemo {
	...
	public void runSerial() {
		...
		finish
			ateach(point(:rank==1) i : expectedReturnRate.distribution){
...
class PriceStock {
	...
	public ToResult getResult() {
		ToResult res = new ToResult(expectedReturnRate, volatility, volatility2, finalStockPrice, pathValue);
		return res;
	}
}
